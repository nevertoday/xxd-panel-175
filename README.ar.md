...
# XXD Panel 175｜مشهد ورقي عاجي بإضاءة كهرمانية خلفية
...
مجسم ورقي صغير بنسبة 20–25% وفراغ 75–80%، بعاج دافئ وإضاءة كهرمانية خلفية وظلال بنية دافئة؛ اللمسات الحمراء أو الحبرية أقل من 1%.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 175 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-175`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-175 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-175-prompt.en.md) أو [بالصينية](references/xxd-panel-175-prompt.zh-CN.md).
